...
function corsHeaders(origin) {
  // Solo devuelve el origen permitido si coincide; de lo contrario el navegador bloqueará la petición
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const SHEETS_WEBHOOK = 'https://script.google.com/macros/s/AKfycbxa4GLyI4FjPXghzHVE4GWO3b2RKiKSacqysIl6lh1dnBk-559gV-4qczql5ud4_jDi/exec';
    context.waitUntil(
